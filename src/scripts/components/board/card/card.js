...
export default class Card {
  ...
  constructor(params = {}, callbacks = {}) {
    ...
    this.cardWasGeneratedByUser = this.params.wasGeneratedByUser;
    ...
    const ratingShouldBeVisible = this.shouldUserSeeRating();
    this.dom.style.setProperty('--has-rating', ratingShouldBeVisible ? 1 : 0);
    this.ratingBox.toggleVisible(ratingShouldBeVisible);
  ...
  /**
   * Check if the card was generated by the user.
   * @returns {boolean} True if the card was generated by the user, false otherwise
   */
  wasGeneratedByUser() {
    return this.cardWasGeneratedByUser;
  }

  /**
   * Check if the user should see the rating box.
   * @returns {boolean} True if the user should see the rating box, false otherwise
   */
  shouldUserSeeRating() {
    ...
    const cardHasRating = typeof this.getRating() === 'number';
    return this.cardWasGeneratedByUser && cardHasRating || !this.cardWasGeneratedByUser;
  }
  ...
  setCapabilities(capabilities = []) {
    ...
    const showRating = this.shouldUserSeeRating();
    this.dom.style.setProperty('--has-rating', showRating ? 1 : 0);
    this.ratingBox?.toggleVisible(showRating);
  }
  ...
  setRating(rating, options = {}) {
    ...
    if (
      ...
      (typeof rating !== 'number' || rating < RATING_MIN || rating > RATING_MAX)
    ) {
      return;
    }
